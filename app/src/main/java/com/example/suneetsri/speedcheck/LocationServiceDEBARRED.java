...
public class LocationServiceDEBARRED extends IntentService implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public LocationServiceDEBARRED()
    {
        super("Location");
     ...
     */
    public LocationServiceDEBARRED(String name) {
        super(name);
    }
    ...
    public void onLocationChanged(Location location) {
       ...
       // speed= Float.parseFloat(sharedPreferences.getString("SPEED_LIMIT","0"));
        ...
        Log.e("SAA", "onLocationChanged:Service "+speed );
